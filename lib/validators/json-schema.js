...
JsonSchema = (function() {
  ...
  JsonSchema.prototype.validate = function() {
    ...
    return this.output = this.validatePrivate();
  };
      ...
      return amanda.validate(this.data, this.schema, json_schema_options, (function(_this) {
        return function(error) {
          ...
          if ((error != null ? error.length : void 0) > 0) {
            for (i = _i = 0, _ref = error.length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
              if (error[i].property === '') {
                error[i].property = [];
              }
            }
